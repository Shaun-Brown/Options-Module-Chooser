...
public class ButtonPane extends HBox {
	...
	private Button clear, submit, restore, add, remove;
...
//	    
	    ObservableList<String> list = FXCollections.observableArrayList("ComputerScience", "Software Engineering");
	...
	public void addAddHandler(EventHandler<ActionEvent> handler) { add.setOnAction(handler);}

	public void addRemoveHandler(EventHandler<ActionEvent> handler) {remove.setOnAction(handler);}
